...
export default function Cart() {
  const { state, cartTotals, updateQuantity, removeFromCart, setCoupon } =
    useStore();
  ...
  return (
    <Page className={styles.page}>
      <Seo
        title="Cart"
        description="Review cart items, coupon, shipping and order summary."
      />
      <h1>Shopping Cart</h1>
      <div className={styles.layout}>
        ...
        <aside className={styles.summary}>
          ...
          <p>
            <span>Subtotal</span>
            <strong>{currency(cartTotals.subtotal)}</strong>
          </p>
          <p>
            <span>Discount</span>
            <strong>-{currency(cartTotals.discount)}</strong>
          </p>
          <p>
            <span>Shipping</span>
            <strong>
              {cartTotals.shipping ? currency(cartTotals.shipping) : "Free"}
            </strong>
          </p>
          <p>
